...
genNoBlkModsBlk blk prntBlk elem' elemMods
    =
    Gen.genBlk blk [] prntBlk elem' elemMods
...
decorRoot = (`Rdr.runReader` (fix defCfg)) . (IntrGen.decor . IntrGen.Blk)
